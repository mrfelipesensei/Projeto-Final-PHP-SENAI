...
<body>
    ...
    <main>
        <div class="conteiner">
            ...
            <form action="../controller/cadastrarFuncController.php" method="post">
                ...
                <br>
                <input type="text" name="usuario" id="usuario" placeholder="Seu nome de usuário" class="inputs">
                <br>
                <input type="password" name="senha" id="senha" placeholder="Sua senha" class="inputs">
                <br>
                <select name="perfil">
